...
import { RestoreAllocationGroupService } from "../services/restore.service.js";
...
export const restore = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const restoreAllocationGroupService = new RestoreAllocationGroupService(db);
    await restoreAllocationGroupService.handle(req.params.id, userId, session);
